...
//var url = 'https://bit.ly/dan-abramov'
var url=''
...
let cotaId: string = '0xfca267ddc876c8ed68817e6fb6acb53ccf3db2bd'
    ...
    withdrawals: [
      {
        ...
        state: '0x00',
        // characteristic must be hex string starts with '0x' and of size 20
